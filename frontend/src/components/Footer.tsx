  ...
  return (
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
            ...
            <div className="flex items-center gap-3 mb-4">
              {siteImages.logo ? (
                <img
                  ...
                  className="h-9 sm:h-10 w-auto max-w-[140px] sm:max-w-[160px] object-contain shrink-0"
                />
              ) : (
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-700 shrink-0" />
              )}
              <span className="font-bold text-white text-base sm:text-lg">Smart Games & Academy</span>
            </div>
        ...
        <div className="border-t border-gray-800 mt-10 sm:mt-12 pt-6 sm:pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-center sm:text-left">
